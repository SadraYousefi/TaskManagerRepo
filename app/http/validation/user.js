...
const createUserValidation = joi.object({
    ...
    password: joi.string().min(6).pattern(new RegExp('^[a-zA-Z0-9]{3,30}$')).error(new createHttpError.BadRequest("Password must Contain 8 char at least 1 number 1 string")),
